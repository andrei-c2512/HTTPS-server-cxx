...
namespace thm::core{
    ...
    public:
                    ...
                    :sslContext(asio::ssl::context::sslv23) , workGuard(asioContext.get_executor())
            {
                    ...
                    _abort = _abort || util::log::handleError(ec, "Sucessfully loaded the certificate file", "Failed to use the certificate file");
                    ...
                    for (const std::string& filePath : approvedCerts) {
                            ...
                            _abort = _abort || util::log::handleError(ec, "Added new file for verification", "Failed to load the certificate file");
                    }
            }
            ~SecureClient() {
                    disconnect();
            ...
            void disconnect() {
                    ...
                    util::log::message("Disconnected from server");
            }
            ...
            void update() override {
                    while (readQueue.empty() == false) {
                            ...
                            readQueue.pop_front();
                            util::log::info("Processing new message...");
