...
namespace thm::detail{
    ...
    public:
            HttpResponseReader(bool& canWriteFlag ,util::ds::TsQueue<std::shared_ptr<HttpResponse>>& queue0) 
    ...
    protected:
            ...
            util::ds::TsQueue<std::shared_ptr<HttpResponse>>& queue;
